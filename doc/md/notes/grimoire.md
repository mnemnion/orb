...
#+begin_example#+end_example#+begin_example#tag#+end_example
Even clings are resolved forwards:

#+begin_example#tag#+end_example
...
If you write
  ...
  #+begin_example# Top Header
## Second Header  #+end_example#+begin_example# Top Header ▼
## Second Header ►#+end_example
...
#+begin_src# Top Header ▼
## Second Header ►#+end_src
...
#+begin_src org    #formulas: etc...#+end_src
