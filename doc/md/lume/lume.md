...
A [deque](https://gitlab.com/special-circumstance/deque/-/blob/trunk/) on which files are placed, to be turned into
...
The rack is a [Set](https://gitlab.com/special-circumstance/set/-/blob/trunk/) of the coroutines, to be iterated twice,
...
- db:
  ...
  - stmts:  The [database statements](https://gitlab.com/special-circumstance/orb/-/blob/trunk/) necessary to
...
Creates and returns a [Manifest](https://gitlab.com/special-circumstance/orb/-/blob/trunk/)\.
