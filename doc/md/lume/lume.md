...
A [deque](some stuff) on which files are placed, to be turned into
...
The rack is a [Set](some stuff) of the coroutines, to be iterated twice,
...
- db:
  ...
  - stmts:  The [database statements](some stuff) necessary to
...
Creates and returns a [Manifest](some stuff)\.
