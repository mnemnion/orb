...
For a shim, we'll short circuit this:
...
If ``lfs`` isn't in the search path, as it eventually won't be, we'll load it
from here.


This prevents the ffi from dying on a redeclaration.
